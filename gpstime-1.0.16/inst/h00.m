...
function [tgps]=h00(tgps)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } h00 (@var{tgps})
%% Fill a tgps structure with current hour at 00 seconds
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
...
[tgps]=ymdhms_t(tgps.yyyy,tgps.mon,tgps.dd,tgps.hh,0,0);
