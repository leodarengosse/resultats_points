...
function [tgps]=add_s(tgps,s)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } add_s (@var{tgps},@var{s})
%% Add @var{s} seconds to a tgps structure
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
%% @item @var{tgps} : gpstime structure
%% @item @var{s} : number of seconds (+/-)
%% @end itemize  
%% @item Output :
%% @itemize @minus
%% @item @var{tgps} : gpstime structure
