...
function [tgps]=gpswkd_t(gpsweek, wday)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } gpswkd_t (@var{gpsweek},@var{wday})
...
%% @item @var{wday} : Day of week (sunday = 0)
%% @end itemize  
%% @item Output :
%% @itemize @minus
...
%% @end deftypefn
    ...
    GPS0 = 315964800.0; % 1980-01-06 in seconds starting from 1970-01-01T00:00:00
    njgps = gpsweek * 7 + wday;
    s1970 = njgps * 86400 + GPS0;
