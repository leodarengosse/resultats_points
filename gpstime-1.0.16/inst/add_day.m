...
function [tgps]=add_day(tgps,d)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } add_day (@var{tgps},@var{d})
%% Add @var{d} days to a tgps structure
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
%% @item @var{tgps} : gpstime structure
%% @item @var{d} : number of days (+/-)
%% @end itemize  
%% @item Output :
%% @itemize @minus
%% @item @var{tgps} : gpstime structure
...
[tgps]=s1970_t(tgps.s1970+d*86400.0);
