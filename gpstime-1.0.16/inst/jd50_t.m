...
function [tgps]=jd50_t(julian_date_50)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } jd50_t (@var{julian_date_50})
%% Calculate all time elements from Julian Date 1950 (GRGS)
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
%% @var{julian_date_50} : Julian Date 1950 (float)
%% @end itemize  
%% @item Output :
%% @itemize @minus
...
%%
%% @example
%% example : [tgps]=jd50_t(2455197.000)
%% tgps =
