...
function [tgps]=wk00(tgps)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } wk00 (@var{tgps})
%% Fill a tgps structure with current week day 0 (sunday) at 00:00:00
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
