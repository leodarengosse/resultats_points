...
function [tgps]=day00(tgps)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } day00 (@var{tgps})
%% Fill a tgps structure with current day at 00:00:00
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
