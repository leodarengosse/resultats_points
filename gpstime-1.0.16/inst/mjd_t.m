...
function [tgps]=mjd_t(mjd)
%% -*- texinfo -*-
%% @deftypefn {Function File} {[@var{tgps}] = } mjd_t (@var{mjd})
%% Calculate all time elements from from Modified Julian Date
%%
%% @itemize @bullet
%% @item Input :
%% @itemize @minus
%% @var{mjd} : Modified Julian Date (float)
%% @end itemize  
%% @item Output :
%% @itemize @minus
...
%% @end deftypefn
    ...
    MJD2000 = 51544.5; % J2000 in mjd
    J2000 = 946728000.0; % J2000 in seconds starting from 1970-01-01T00:00:00

    s1970 = (mjd - MJD2000) * 86400 + J2000; % seconds starting from 1970-01-01T00:00:00
