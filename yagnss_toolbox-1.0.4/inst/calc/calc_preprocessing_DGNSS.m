function [G1,G2,result,result_LS_code_base]=calc_preprocessing_DGNSS(RNX_header_base, RNX_data_base, RNX_header_rover, RNX_data_rover, NAV_header, NAV_data, X0_base, epoch, options)
%% function [G1,G2,result,result_LS_code_base]=calc_preprocessing_DGNSS(RNX_header_base, RNX_data_base, RNX_header_rover, RNX_data_rover, NAV_header, NAV_data, X0_base, epoch, options)
%% Data organization and preparation before DGNSS processing - interface of calc_preprocessing for DGNSS
%%
...
%% }
%%
%% - result_LS_code_base : LS code estimation result structure for base station. See calc_LS_code() for details
%%
%% Output
...
%%    }
%% 
%%      X0 =                                   : fixed X0 for base station
%%        
%%		   X0_base
%%		   Y0_base
%%		   Z0_base
%%
%%      cdtr                                   : computed cdtr for base station
%%
%%      cGGTO                                  : computed cGGTO for base station
%%
%%      cGPGL                                  : computed cGPGL for base station
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
