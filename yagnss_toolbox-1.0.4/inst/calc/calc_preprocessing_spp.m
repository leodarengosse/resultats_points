function [G,result]=calc_preprocessing_spp(RNX_header,RNX_data,NAV_header,NAV_data,epoch,options)
%% function [G,result]=calc_preprocessing_spp(RNX_header,RNX_data,NAV_header,NAV_data,epoch,options)
%% Data organization and preparation before spp processing - interface for calc_preprocessing in case of spp preprocessing
%%
...
%%
%% Output
%% - G : cell tab (G1 if spp or DGNSS, G1 + G2 if phase)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RNX_header_base = struct;
RNX_data_base = struct;
RNX_header_rover = RNX_header;
RNX_data_rover = RNX_data;
X0_base = NaN;
...
[G1,G,result,result_LS_code_base,result_LS_code_rover]=calc_preprocessing(RNX_header_base,RNX_data_base,RNX_header_rover,RNX_data_rover,NAV_header,NAV_data,X0_base,epoch,options);
